...
namespace InfServer.Script.GameType_Multi
{
    public partial class Database
    {
        ...
        public Dictionary<ushort, Structure> loadStructures(string player)
        {
            ...
            foreach (XmlNode Node in _data[player].SelectNodes("playerTable/structures"))
            {
