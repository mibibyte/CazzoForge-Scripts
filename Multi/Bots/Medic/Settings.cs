...
{   // Script Class
    ...
    public partial class Medic : Bot
    {
        ...
        public float healfarDist = 1.6f;                    //The distance from the player where we actively pursue them
        ...
        public const int c_playerMaxRangeHeals = 2100;      //The max range the bot will look for players to heal
